...
// Asegurar que no haya salida HTML
ensureCleanOutput();
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    handleError('Método no permitido. Use POST para iniciar sesión.');
}
...
if (!$data || !isset($data['correo_institucional']) || !isset($data['contraseña'])) {
    handleError('Datos incompletos o formato incorrecto');
}
...
try {
    ...
    // Manejo de errores usando nuestra función
