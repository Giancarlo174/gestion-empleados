    ...
    <div class="card-body">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?php echo (!empty($codigo_err)) ? 'is-invalid' : ''; ?>" id="codigo" name="codigo" value="<?php echo $codigo; ?>" maxlength="2" required>
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Agregar Cargo
                </button>
