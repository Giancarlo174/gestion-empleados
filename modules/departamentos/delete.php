...
if (isset($_GET["codigo"]) && !empty(trim($_GET["codigo"]))) {
    ...
    $sql_check_cargos = "SELECT COUNT(*) as total FROM cargo WHERE dep_codigo = ?";
    if ($stmt_check = mysqli_prepare($conn, $sql_check_cargos)) {
        ...
        if ($row_check['total'] > 0) {
            $error = "No se puede eliminar este departamento porque tiene cargos asociados.";
        } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($error)) {
    // Confirmar que se recibió el código del departamento
    if (isset($_POST["codigo"]) && !empty($_POST["codigo"])) {
        ...
        if ($stmt = mysqli_prepare($conn, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                $error = "Error al eliminar el departamento: " . mysqli_error($conn);
            }
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Eliminar Departamento</h1>
...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    <div class="mt-3">
        <a href="list.php" class="btn btn-primary">Volver a la lista de departamentos</a>
    </div>
</div>
<?php endif; ?>
...
<div class="card">
    <div class="card-body text-center">
        <div class="mb-4">
            ...
            <h2 class="mt-3">¿Está seguro que desea eliminar este departamento?</h2>
        ...
        <div class="alert alert-warning">
            ...
            <p class="mb-0"><strong>IMPORTANTE:</strong> Al eliminar este departamento, también se eliminarán todos los registros asociados.</p>
        </div>
