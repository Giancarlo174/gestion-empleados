...
$sql = "SELECT u.*, e.nombre1, e.apellido1 
        FROM usuarios u 
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    if (!empty($row['nombre1']) && !empty($row['apellido1'])) {
                        echo htmlspecialchars($row['nombre1'] . ' ' . $row['apellido1']);
                    } else {
                        echo '<span class="text-muted">No vinculado a empleado</span>';
                    }
                    ?>
                </td>
